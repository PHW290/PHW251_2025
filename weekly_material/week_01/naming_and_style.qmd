...
There are also R packages built to help guide or correct your code according to specific style guides. The [styler package](https://styler.r-lib.org/) will take code that you've written (either a whole file or just a chunk of code) and apply the Tidyverse Style (or a custom style) to it. 
